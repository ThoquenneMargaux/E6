 ...
 */
class Etat extends \mttl\gsbBundle\Entity\Etat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'mttl\\gsbBundle\\Entity\\Etat' . "\0" . 'idetat', '' . "\0" . 'mttl\\gsbBundle\\Entity\\Etat' . "\0" . 'libelle');
        }

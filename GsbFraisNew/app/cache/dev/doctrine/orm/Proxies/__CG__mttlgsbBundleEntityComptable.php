 ...
 */
class Comptable extends \mttl\gsbBundle\Entity\Comptable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'mttl\\gsbBundle\\Entity\\Comptable' . "\0" . 'idcomptable', '' . "\0" . 'mttl\\gsbBundle\\Entity\\Comptable' . "\0" . 'nom', '' . "\0" . 'mttl\\gsbBundle\\Entity\\Comptable' . "\0" . 'prenom', '' . "\0" . 'mttl\\gsbBundle\\Entity\\Comptable' . "\0" . 'login', '' . "\0" . 'mttl\\gsbBundle\\Entity\\Comptable' . "\0" . 'mdp', '' . "\0" . 'mttl\\gsbBundle\\Entity\\Comptable' . "\0" . 'profil', '' . "\0" . 'mttl\\gsbBundle\\Entity\\Comptable' . "\0" . 'connecte');
        }

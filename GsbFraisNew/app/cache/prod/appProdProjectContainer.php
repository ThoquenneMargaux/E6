...
class appProdProjectContainer extends Container
{
     ...
     */
    protected function getDbtestService()
    {
        return $this->services['dbtest'] = new \PDO('mysql:host=localhost;dbname=GsbCRSlamV2015', 'root', 'mysql', array(3 => 2));
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'GsbCRSlamV2015', 'user' => 'root', 'password' => 'mysql', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\mttl\\gsbBundle\\Entity'))), 'mttl\\gsbBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('mttlgsbBundle' => 'mttl\\gsbBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e0224d00a18e418ccf8cb3dd06d4a26071379559f08fded2c323451366e2a3f0');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\mttl\\gsbBundle/Resources/views'), 'mttlgsb');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('028014c70cf281a1b7dccb2b9e7b30ec9fc61392');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('587a916a3aba99.27034872')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'mttlgsbBundle' => 'mttl\\gsbBundle\\mttlgsbBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'GsbCRSlamV2015',
            'database_user' => 'root',
            ...
            'secret' => '028014c70cf281a1b7dccb2b9e7b30ec9fc61392',
            'locale' => 'en',
            ...
            'kernel.secret' => '028014c70cf281a1b7dccb2b9e7b30ec9fc61392',
            ...
            'dbtest.dsn' => 'mysql:host=localhost;dbname=GsbCRSlamV2015',
            'dbtest.username' => 'root',
            'dbtest.password' => 'mysql',
